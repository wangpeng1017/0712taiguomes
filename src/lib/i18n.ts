...
const EN: Record<string, string> = {
  ...
  "搜索批次、工单、产品、设备或操作员": "Search batch, work order, product, equipment, or operator", "搜索批次号、工单、产品或操作员": "Search batch, work order, product, or operator", "全部状态": "All Statuses",
  ...
  "全部": "All", "暂无已下达工单或生产批次": "No released work orders or production batches", "暂无生产批次": "No production batches", "暂无生产记录": "No production records", "暂无记录": "No records", "暂无预警": "No alerts",
